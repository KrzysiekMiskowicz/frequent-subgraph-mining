...
from src.frequent_subgraph_mining import MoSSFeatureExtractorLimitedEdges
...
moss_extractor = MoSSFeatureExtractorLimitedEdges(min_support=0.1, max_edges=3)
...
print(f"Accuracy: {accuracy_score(valid_dataset.y[:, 0], y_pred):.2f}")  # 0.62
