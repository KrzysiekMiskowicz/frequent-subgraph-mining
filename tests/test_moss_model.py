...
from src.frequent_subgraph_mining import MoSSFeatureExtractor
...
moss_extractor = MoSSFeatureExtractor(min_support=0.1, max_edges=5)
...
print(f"Accuracy: {accuracy_score(valid_dataset.y[:, 0], y_pred):.2f}")  # 0.56
