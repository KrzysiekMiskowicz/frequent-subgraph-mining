...
from src.frequent_subgraph_mining import MoSSFeatureExtractorLimitedEdgesNodes
...
moss_extractor = MoSSFeatureExtractorLimitedEdgesNodes(min_support=0.1, max_edges=5, max_nodes=4)
